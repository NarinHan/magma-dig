...
cp "$WORK/poppler/utils/"{pdfimages,pdftoppm} "$OUT_COV/"
$CXX $CXXFLAGS -std=c++11 -I"$WORK/poppler/cpp" -I"$TARGET_COV/repo/cpp" \
    "$TARGET_COV/src/pdf_fuzzer.cc" -o "$OUT_COV/pdf_fuzzer" \
